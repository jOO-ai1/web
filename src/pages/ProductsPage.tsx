  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <div className={view === "grid" ? "grid grid-cols-1 md:grid-cols-3 gap-6" : "flex flex-col gap-6"}>
        {filtered.map((prod) => (
          <div key={prod.id} className="glass p-6 rounded-2xl shadow-xl border border-white/25 flex flex-col group hover:shadow-2xl transition-all">
            <img src={prod.image} className="w-full h-40 object-cover rounded-xl mb-3 group-hover:scale-110 transition" />
